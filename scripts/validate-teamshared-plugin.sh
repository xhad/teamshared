...
check "$PLUGIN/install/codex/mcp.toml"
check "$PLUGIN/install/pi/mcp.json"
check "$PLUGIN/install/hermes/mcp.yaml"
check "$PLUGIN/install/hermes/capture.py"
check "$PLUGIN/clients/protocol.md"
