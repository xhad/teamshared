...
| `integration_list`          | List the org's connected Gmail/Slack integrations            |
...
teamshared can connect a user's Gmail and Slack accounts so agents can search,
read, and send through teamshared. Connections are **per-human**
...
- **Bidirectional**: `integration_send` posts/emails using the personal
