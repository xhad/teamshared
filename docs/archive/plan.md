> **Archived (2026-06):** original prompt/notes that kicked off teamshared.
> Superseded by the shipped architecture documented in `README.md` and
> `AGENTS.md`. Kept only as provenance.
