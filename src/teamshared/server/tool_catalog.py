...
_CATALOG: list[dict[str, Any]] = [
    ...
    # --- files ---
    {"name": "file_create", "tier": "core", "group": "files",
     "summary": "Create a versioned HTML/Markdown shared file (private by default)",
     "example": {"title": "Q3 launch plan", "content": "# Goals\n...", "content_format": "markdown"}},
    {"name": "file_upload_request", "tier": "core", "group": "files",
     "summary": "Get a one-time local uploader script to push a large local file into a shared file",
     "example": {"title": "Vault modeller", "content_format": "auto", "filename": "modeller.html", "publish": True}},
    {"name": "file_update", "tier": "core", "group": "files",
     "summary": "Append a new version to an existing shared file (immutable history)",
     "example": {"file_id": "<uuid>", "content": "# Goals (revised)\n..."}},
    {"name": "file_get", "tier": "extended", "group": "files",
     "summary": "Fetch a shared file with its latest version content",
     "example": {"file_id": "<uuid>"}},
    {"name": "file_list", "tier": "extended", "group": "files",
     "summary": "List active shared files in the caller's org",
     "example": {"limit": 50}},
    {"name": "file_publish", "tier": "core", "group": "files",
     "summary": "Publish a shared file: generate the public /s/{token} URL + mirror to bucket",
     "example": {"file_id": "<uuid>"}},
    {"name": "file_unpublish", "tier": "extended", "group": "files",
