...
_CATALOG: list[dict[str, Any]] = [
    ...
    {"name": "version", "tier": "core", "group": "ops",
     ...
     "example": {"installed_rule_version": "1.10.1"}},
    ...
    {"name": "context_commit", "tier": "core", "group": "ops",
     "summary": "Turn-end batch: assistant summary + durable facts + optional session close",
     "example": {"summary": "Fixed the flaky test by pinning the clock.",
                 "facts": [{"content": "CI clock is pinned via freezegun", "kind": "fact"}],
    ...
    {"name": "memory_soul_get", "tier": "core", "group": "memory",
     "summary": "Private compressed identity block for this person in this org",
     "example": {}},
    {"name": "memory_soul_set", "tier": "core", "group": "memory",
     "summary": "Replace private soul (keep short; server caps length)",
     "example": {"body_md": "# Soul\nname: Ada\nrole: eng lead\nstyle: concise\n"}},
    ...
    {"name": "memory_session_ensure", "tier": "core", "group": "memory",
     "summary": "Bootstrap session; returns soul when account-linked",
     "example": {"repo": "Users-me-code-myrepo", "topic": "debug retrieval bug", "fresh": True}},
    {"name": "memory_session_open", "tier": "core", "group": "memory",
     "summary": "Open working-memory session for this chat (prefer memory_session_ensure)",
     "example": {"topic": "debug retrieval bug", "repo": "Users-me-code-myrepo"}},
    {"name": "memory_session_append", "tier": "core", "group": "memory",
     "summary": "Append a turn (self-heals expired sessions; watch for reopened)",
