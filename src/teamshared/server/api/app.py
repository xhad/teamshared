...
def build_api_app(
    ...
    *,
    ...
    routes = [
        ...
        Route("/orgs", create_org, methods=["POST"]),
        Route("/orgs/me", org_me, methods=["GET"]),
        Route("/teams", create_team, methods=["POST"]),
        ...
        Route("/memory", ingest_memory, methods=["POST"]),
        Route("/memory/search", search_memory, methods=["POST"]),
        Route("/memory/{memory_id}", get_memory, methods=["GET"]),
        Route("/memory/{memory_id}", patch_memory, methods=["PATCH"]),
        Route("/memory/{memory_id}", delete_memory, methods=["DELETE"]),
        Route("/memory/{memory_id}/share", share_memory, methods=["POST"]),
        Route("/audit", list_audit, methods=["GET"]),
        Route("/connectors", list_connectors, methods=["GET"]),
        Route("/connectors", create_connector, methods=["POST"]),
        Route("/connectors/{connector_id}/sync", sync_connector, methods=["POST"]),
        Route("/connectors/{connector_id}", delete_connector, methods=["DELETE"]),
        Route("/members", list_members, methods=["GET"]),
        Route("/members/{user_id}/roles", grant_role, methods=["POST"]),
        Route("/roles", list_roles, methods=["GET"]),
        Route("/retention-policies", create_retention, methods=["POST"]),
        Route("/retention-policies", list_retention, methods=["GET"]),
        Route("/admin/export", export_org, methods=["GET"]),
