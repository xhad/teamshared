...
- :mod:`teamshared.memory.procedural` -- Postgres-backed agent-callable playbooks.
- :mod:`teamshared.memory.skills` -- Postgres-backed atomic agent skills (building blocks).
- :mod:`teamshared.memory.strategic` -- Org vision/mission/purpose and OKR cycles.
